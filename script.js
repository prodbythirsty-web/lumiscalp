  ...
  cartItems.forEach((item, idx) => {
    ...
    if (massagerQty > 0) {
      html += `
        <div class="cart-item cart-addon-row">
          <div class="cart-item-top">
            <img class="cart-item-img" src="massager.jpg" alt="Scalp Massager">
            <div class="cart-item-info">
    ...
    if (item.bundle === 2 && serumQty > 0) {
      ...
      html += `
        <div class="cart-item cart-addon-row">
          <div class="cart-item-top">
            <img class="cart-item-img" src="serum.jpg" alt="45-Day Copper Hair Growth Serum">
            <div class="cart-item-info">
    ...
    if (guarQty > 0) {
      html += `
        <div class="cart-item cart-addon-row">
          <div class="cart-item-top">
            <img class="cart-item-img" src="guarantee.png" alt="90-Day Money-Back Guarantee">
            <div class="cart-item-info">
