      ...
      html += `
        <div class="cart-item cart-addon-row">
          <div class="cart-item-top">
            ...
            <button class="cart-item-trash" onclick="adjustQty(${idx},'massagerQty',-massagerQty)" aria-label="Remove">${TRASH_ICON}</button>
          </div>
          <div class="cart-item-bottom">
            <div class="qty-stepper">
      ...
      html += `
        <div class="cart-item cart-addon-row">
          <div class="cart-item-top">
            ...
            <button class="cart-item-trash" onclick="adjustQty(${idx},'serumQty',-serumQty)" aria-label="Remove">${TRASH_ICON}</button>
          </div>
          <div class="cart-item-bottom">
            <div class="qty-stepper">
      ...
      html += `
        <div class="cart-item cart-addon-row">
          <div class="cart-item-top">
            ...
            <button class="cart-item-trash" onclick="adjustQty(${idx},'guaranteeQty',-guarQty)" aria-label="Remove">${TRASH_ICON}</button>
          </div>
          <div class="cart-item-bottom">
            <div class="qty-stepper">
